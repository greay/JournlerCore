...
#include <sys/types.h>
#include <sys/event.h>
#import <JournlerCore/JournlerFileWatcher.h>
...
@interface JournlerKQueue : NSObject <JournlerFileWatcher>
{
...
@interface NSObject (JournlerKQueueDelegate)

-(void) kqueue: (JournlerKQueue*)kq receivedNotification: (NSString*)nm forFile: (NSString*)fpath;
