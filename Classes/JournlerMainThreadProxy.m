...
@implementation JournlerMainThreadProxy
...
@implementation NSObject (JournlerMainThreadProxy)

-(id)	mainThreadProxy
{
	return [[[JournlerMainThreadProxy alloc] initWithTarget: self] autorelease];
}

-(id)	copyMainThreadProxy
{
	return [[JournlerMainThreadProxy alloc] initWithTarget: self];
}
